...
if __name__ == '__main__':
    s_raw_data_root = '/home/yuliu/Documents/0RSNet/misc/raw_VH_set/'
    tile_result_root = '/home/yuliu/Documents/0RSNet/misc/raw_VH_set/'
    xd_check_top2_score(11)
    # xh_save_fake_color_set()
    # xh_save_fake_color_nerror_set()
    # xf_save_crop_set()
    # xf_save_fake_color_one(5, 'tmp_wBP/pd_ois_50_','pd_ois_50_wbp_')
