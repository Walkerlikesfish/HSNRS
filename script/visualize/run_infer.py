...
parser.add_argument("-c", "--caffe", help="indicate which caffe want to use: 1 SegNet caffe")
...
if int(args.caffe) == 1:
    print "using SegNet caffe!"
    caffe_root = caffe_SegNet_root
elif int(args.caffe) == 0:
    print "using BLVC_M caffe!"
    caffe_root = caffe_bvlc_root
elif int(args.caffe)==2:
    print "using SegNet RS caffe!"
    caffe_root = caffe_SegNetRS_root
else:
    print "Don't you dare mess with me !"
